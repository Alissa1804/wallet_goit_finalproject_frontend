...
.required('Enter you first name')
  ...
  return (
      <Formik
        ...
        validateOnBlur
      >
        {({handleChange, handleBlur, touched, isValid, dirty, values, errors}) => (
          <Form className={styles.form}>
            ...
            <div className={styles.inputContainer}>
              <EmailIcon className={styles.inputIcon} style={{ color: '#e0e0e0' }}/>
              <input
            ...
            <div className={styles.inputContainer}>
              <LockIcon className={styles.inputIcon} style={{ color: '#e0e0e0' }}/>
              <input
                className={styles.input}
                type="text"
                name="password"
            ...
            {touched.confirmPassword && errors.confirmPassword ? <p style={{ color: 'red' }}>{errors.confirmPassword}</p> : null}
            <div className={styles.inputContainer}>
              <LockIcon className={styles.inputIcon} style={{ color: '#e0e0e0' }}/>
              <input
                className={styles.input}
            ...
            <div className={styles.inputContainer}>
              <AccountBoxIcon className={styles.inputIcon} style={{ color: '#e0e0e0' }}/>
              <input
                className={styles.input}
                type="text"
                name="name"
            ...
            <div className={styles.buttonContainer}>
              <button type="submit" className={styles.mainButton} disabled={!isValid && !dirty}>
                Register
              </button>
