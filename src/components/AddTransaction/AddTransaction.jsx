  ...
  return (
    <>
      {isTransactionModalOpen && (
        <div className={styles.overlay} onClick={handleBackdropClick}>
          <div className={styles.modal__container}>
            <div className={styles.modal__container_transaction}>
              Add transaction
              {/* <div className={styles.switcher} >
              <span >
                    ...
                    <div className={styles.category_conteiner}>
                      ...
                      <div className={styles.category_control}>
                        <div className={styles.category_control_field}>
                          <div
                            className={
                              styles.category_control_field_placeholder
                            }
                            as="select"
                            name="category"
                          >
                          ...
                          <div
                            className={
                              styles.category_control_field_placeholder_selectCategory
                            }
                          >
                            <input className={styles.category_input}></input>
                          </div>
                        </div>
                        <div className={styles.category_menu}>
                          <span></span>
                          ...
                          <div className={styles.category_menu_down}>
                            ...
                            >
                              <g></g>
                              <path d="M16.354 5.075l-7.855 7.854-7.853-7.854 0.707-0.707 7.145 7.146 7.148-7.147 0.708 0.708z"></path>
                            </svg>
                          </div>
                        </div>
                      </div>
